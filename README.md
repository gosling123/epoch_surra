...
#### (NOTE: sdf package comes with EPOCH. Instructions to install package are given in the Acessing EPOCH section, please do not do pip3 install sdf as this is a seprate package.)
